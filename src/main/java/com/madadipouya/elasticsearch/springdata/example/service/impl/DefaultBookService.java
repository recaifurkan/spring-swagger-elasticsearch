...
public class DefaultBookService implements BookService {
    ...
    public List<Book> findByTitleAndAuthor(String title, String author) {
        ...
        boolean b = criteria.must().addAll(Arrays.asList(QueryBuilders.matchQuery("authorName", author), QueryBuilders.matchQuery("title", title)));
        return elasticsearchTemplate.queryForList(new NativeSearchQueryBuilder().withQuery(criteria).build(), Book.class , IndexCoordinates.of("books"));
    }
